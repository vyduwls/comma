...
<div id="body" class="container">
	...
	<div id="side" class="col-lg-3" style="height: 800px">
		<div class="profile" style="margin-top:52px;">
			<!-- 프로필 버튼 -->
			<div class="button">
				<a id="myPage" type="button" style="border-left:1px solid #ccc"  class="btn btn-default btn-block myPage-active"
					href="${pageContext.request.contextPath}/customer/modifyMember.do">회원정보수정</a>
				<a id="message" type="button" style="border-left:3px solid rgb(66,133,244)" class="btn btn-default btn-block"
